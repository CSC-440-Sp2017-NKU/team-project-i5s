Rails.application.routes.draw do
  ...
  #user files
  post 'UploadUserFile', to: 'users#upload_user_file', as: :upload_user_file
  delete 'DeleteUserFile', to: 'users#delete_user_file'
  get 'Download/:id', to:'users#download_file', as: :item_download
